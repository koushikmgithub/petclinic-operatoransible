...
# ansible.op.com/petclinic-operatoransible-bundle:$VERSION and ansible.op.com/petclinic-operatoransible-catalog:$VERSION.
IMAGE_TAG_BASE ?= dockertestbaby/petclinic-operatoransible
